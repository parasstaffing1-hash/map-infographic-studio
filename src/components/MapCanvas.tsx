  ...
  return (
    <div className="map-stage">
      ...
      {!isEditorialStory && <div className="map-overlay-card">
        ...
        <small>{viewMode === 'world' ? 'India uses the official Survey of India outline' : viewMode === 'india' ? 'Click any state or UT to open its districts' : viewMode === 'usa' ? 'Click any state to open its county map' : viewMode === 'china' ? 'Click any province to open its prefecture map' : 'Click a region to inspect its entity record'}</small>
      </div>}
    </div>
  );
}
